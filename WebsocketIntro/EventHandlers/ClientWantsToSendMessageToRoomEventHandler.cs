...
public class ClientWantsToSendMessageToRoomEventHandler(ClientConnectionsState state, SecurityService.SecurityService securityService) : BaseEventHandler<ClientWantsToSendMessageToRoom>
{
